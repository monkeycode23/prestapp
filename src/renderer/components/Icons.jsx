...
export function ToolOutlined(props) {
  return (
    <svg
...
export function Eye(props) {
  ...
  export function PeopleMoney20Regular(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function MoneyBagBroken(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <g
        ...
        strokeWidth="1.5"
      >
        <path d="M3.172 20.828C4.343 22 6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14c0-1.17 0-2.158-.035-3m-1.137-3.828C19.657 6 17.771 6 14 6h-4C6.229 6 4.343 6 3.172 7.172S2 10.229 2 14c0 1.17 0 2.158.035 3M12 2c1.886 0 2.828 0 3.414.586S16 4.114 16 6M8.586 2.586C8 3.172 8 4.114 8 6"></path>
        <path d="M12 17.333c1.105 0 2-.746 2-1.666S13.105 14 12 14s-2-.746-2-1.667c0-.92.895-1.666 2-1.666m0 6.666c-1.105 0-2-.746-2-1.666m2 1.666V18m0-8v.667m0 0c1.105 0 2 .746 2 1.666"></path>
      </g>
    </svg>
  )
}
...
export function ArrowsSpinCircle(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 26 26"
    ...
    >
      <g fill="currentColor">
        <path d="M8.254 17.596a.5.5 0 0 1 .707-.707A5.5 5.5 0 0 0 18.35 13a.5.5 0 0 1 .999.001a6.5 6.5 0 0 1-11.096 4.596"></path>
        <path d="M16.131 15.416a.5.5 0 0 1-.555-.832l3-2a.5.5 0 1 1 .555.832z"></path>
        <path d="M21.266 15.723a.5.5 0 1 1-.832.554l-2-3a.5.5 0 0 1 .832-.554zm-3.912-7.518a.5.5 0 0 1-.708.707a5.5 5.5 0 0 0-9.389 3.89a.5.5 0 0 1-1-.001a6.5 6.5 0 0 1 11.097-4.596"></path>
        <path d="M9.476 10.385a.5.5 0 0 1 .555.832l-3 2a.5.5 0 1 1-.555-.832z"></path>
        <path d="M4.341 10.078a.5.5 0 1 1 .832-.554l2 3a.5.5 0 0 1-.832.554z"></path>
        <path
          fillRule="evenodd"
...
export function CalendarDays(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M7.185 12.75a.8.8 0 0 1 .8-.8h.01a.8.8 0 0 1 0 1.6h-.01a.8.8 0 0 1-.8-.8m.8 3.2a.8.8 0 0 0 0 1.6h.01a.8.8 0 0 0 0-1.6zm3.21-3.2a.8.8 0 0 1 .8-.8h.01a.8.8 0 0 1 0 1.6h-.01a.8.8 0 0 1-.8-.8m.8 3.2a.8.8 0 0 0 0 1.6h.01a.8.8 0 0 0 0-1.6zm3.21-3.2a.8.8 0 0 1 .8-.8h.01a.8.8 0 0 1 0 1.6h-.01a.8.8 0 0 1-.8-.8m.8 3.2a.8.8 0 0 0 0 1.6h.01a.8.8 0 0 0 0-1.6z"
      ></path>
      <path
        fill="currentColor"
        d="M8.75 2.75a.75.75 0 0 0-1.5 0v1H5.5A2.25 2.25 0 0 0 3.25 6v13a2.25 2.25 0 0 0 2.25 2.25h13A2.25 2.25 0 0 0 20.75 19V6a2.25 2.25 0 0 0-2.25-2.25h-1.75v-1a.75.75 0 0 0-1.5 0v1h-6.5zm10.5 5.5H4.75V6a.75.75 0 0 1 .75-.75h13a.75.75 0 0 1 .75.75zm-14.5 1.5h14.5V19a.75.75 0 0 1-.75.75h-13a.75.75 0 0 1-.75-.75z"
      ></path>
    </svg>
  )
}
...
export function MoneyGraphBarIncreaseUpProductPerformanceIncreaseArrowGraphBusinessChart(
  props,
) {
  return (
    <svg
...
export function MoneyWavy(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
...
export const DollarIcon = ({ className = '', width = '24', height = '24' }) => (
  ...
  export function SackDollar(props) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
...
export const ExpiredDate = (props) => (
  ...
  export const IconoExpirado = (props) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
    ...
    >
      ...
      {/* Línea que representa el tiempo agotado */}
      <line x1="12" y1="6" x2="12" y2="12" />
      <line x1="12" y1="12" x2="16" y2="16" />
      
      {/* Cruz que indica que algo ha expirado */}
  ...
  export function Wallet03(props) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  export function RoundPhoneAndroid(props) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  export function PercentageCircleIcon(props) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      ...
      >
        ...
        >
          ...
          <path
            fill="currentColor"
            d="M15.5 16a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m-7-7a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"
          ></path>
  ...
  export function CalendarDateIcon(props) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
